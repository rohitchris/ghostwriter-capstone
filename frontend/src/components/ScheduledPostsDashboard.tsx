      ...
      <div className="max-w-7xl mx-auto">
        ...
        {posts.length === 0 ? (
          ...
          <div className="space-y-4">
            {posts.map(post => (
              <div key={post.id} className="p-5 rounded-xl bg-slate-800 shadow-lg border-l-4 border-emerald-500 flex flex-col md:flex-row gap-4">
                {/* Image Preview */}
                {post.imageUrl && (
                ...
                <div className="flex-1 min-w-[300px] flex flex-col justify-between">
                  <div>
                    <p className="text-lg font-bold text-white mb-2">{post.platform} Post</p>
